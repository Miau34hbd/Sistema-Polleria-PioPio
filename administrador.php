...
<header>
    ...
    <div class="status-panel">
        <div class="status-box">
                    ...
                    <h3>Realizar inspecciones periódicas y tomar medidas correctivas si es necesario</h3>
                    

        </div>
        <div class="status-box">
        <h3>Supervisar el desempeño del personal y proporcionar retroalimentación constructiva</h3>
        </div>

        <div class="status-box">
           <h3>Asegurarse de que los clientes tengan una experiencia positiva y memorable</h3>
        </div>
...
<div class="sidebar">
    ...
    <div class="nav-item">
        <a href="/NuevaPolleria/logout">Cerrar Sesion </a>
    </div>
