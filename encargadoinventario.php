...
<head>
    ...
    <title>Panel del Encargado del Inventario</title>
    <style>
        body {
...
<header>
    <h1>Panel del Encargado del Inventario</h1>
...
<div class="sidebar">
    ...
    <div class="nav-section">
        ...
        <div id="inventario" class="nav-section-content active">
            <div class="nav-item">
                <a href="revisar_solicitudes.html">Revisar Solicitudes de Insumo</a>
            </div>
            <div class="nav-item">
                <a href="ordenar_compra.html">Ordenar Compra de Insumos</a>
            </div>
            <div class="nav-item">
                <a href="control_articulos.html">Control de Artículos</a>
            </div>
